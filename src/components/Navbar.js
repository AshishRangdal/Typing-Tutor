      ...
      <nav className={`navbar navbar-expand-lg bg-${theme} shadow-sm`}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="https://github.com/AshishRangdal/Typing-Tutor" target="_blank" rel="noreferrer" className={`btn mx-2 ${theme === "dark" ? "btn-outline-light" : "btn-outline-dark"}`}><i className="bi bi-github"></i></a>
